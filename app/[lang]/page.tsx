    ...
    <main>
      ...
      <section className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-16 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight will-change-transform transition-opacity duration-700">
            {tr.heroTitle}
          </h1>
          <p className="mt-4 text-slate-600 max-w-2xl mx-auto transition-opacity duration-700 delay-100">
            {tr.heroSub}
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            {tr.plans.map((p) => (
              ...
              >
                ...
                <a
                  href={p.link}
                  className="mt-6 inline-block w-full text-center rounded-xl bg-indigo-600 text-white font-semibold py-2 hover:scale-[1.01] hover:bg-indigo-700 transition"
                >
                  {p.cta}
                </a>
                ...
                <a
                  href={waLink(p.name)}
                  className="mt-2 inline-block w-full text-center rounded-xl border border-slate-300 bg-white py-2 hover:bg-slate-50 hover:scale-[1.01] transition"
                >
                  WhatsApp
                </a>
              </div>
